...
| COMP-07 | Generated catalogs omitted prior trusted descriptors, invalidating retained rollback versions on adoption. | Repair in progress: explicit trusted descriptor history retention. | Upgrade/catalog-adoption rollback test required. |
