...
class ComponentsPanel(QWidget):
    def __init__(self, parent=None):
        ...
        self.legacy_button.setAccessibleDescription("Opens a file dialog to import an existing MobileNetV2 model directory.")
        self.legacy_button.clicked.connect(self.import_legacy)
        row.addWidget(self.legacy_button)
        self.cancel_button = QPushButton("Cancel")
        self.cancel_button.setAccessibleName("Cancel component process")
        self.cancel_button.setAccessibleDescription("Cancels the currently running component management operation.")
