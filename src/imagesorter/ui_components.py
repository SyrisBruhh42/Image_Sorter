...
class ComponentsPanel(QWidget):
    def __init__(self, parent=None):
        ...
        self.run_button.setAccessibleDescription("Applies the selected action to the selected component.")
        ...
        self.import_button.setAccessibleDescription("Opens a file dialog to select and import a pinned component archive.")
        ...
        self.cancel_button.setAccessibleDescription("Cancels any running component installation or update process.")
