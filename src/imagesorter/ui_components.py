...
class ComponentsPanel(QWidget):
    def __init__(self, parent=None):
        ...
        self.run_button.setToolTip("Apply the selected action to the chosen component.")
        ...
        self.legacy_button.setToolTip("Import existing checksum-verified model and labels directory.")
