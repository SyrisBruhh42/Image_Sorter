...
class ComponentsPanel(QWidget):
    def __init__(self, parent=None):
        ...
        self.run_button.setAccessibleName("Apply component action")
        self.run_button.setAccessibleDescription("Applies the selected action to the chosen component.")
        self.run_button.setToolTip("Apply the selected action for the chosen component.")
        self.run_button.clicked.connect(self.apply)
        row.addWidget(self.run_button)
        self.import_button = QPushButton("Import pack…")
        self.import_button.setAccessibleName("Import component pack")
        self.import_button.setAccessibleDescription("Imports a pinned component archive pack file.")
        self.import_button.setToolTip("Import a pinned component archive file (.tar.gz).")
        ...
        self.legacy_button.setAccessibleDescription("Imports an existing checksum-verified model directory.")
        self.legacy_button.setToolTip("Import existing checksum-verified model files from a directory.")
        self.legacy_button.clicked.connect(self.import_legacy)
        row.addWidget(self.legacy_button)
        self.cancel_button = QPushButton("Cancel")
        self.cancel_button.setAccessibleName("Cancel component operation")
        self.cancel_button.setAccessibleDescription("Cancels the ongoing component operation.")
        self.cancel_button.setToolTip("Cancel the active component operation.")
