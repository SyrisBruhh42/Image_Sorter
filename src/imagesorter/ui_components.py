...
class ComponentsPanel(QWidget):
    def __init__(self, parent=None):
        ...
        self.import_button.setAccessibleDescription("Opens a file dialog to import a pinned component archive.")
        ...
        self.cancel_button.setAccessibleDescription("Cancels the currently running component background operation.")
