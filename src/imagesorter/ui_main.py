...
class MainViewer(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        self.frame_previous.setAccessibleDescription("Steps back to the previous frame or page in multi-frame images.")
        self.frame_previous.setToolTip("Step back to the previous frame or page.")

        self.frame_play = QPushButton("Play")
        self.frame_play.setAccessibleName("Play Animation Button")
        self.frame_play.setAccessibleDescription("Toggles animation playback for multi-frame images or documents.")
        self.frame_play.setToolTip("Toggle animation playback.")

        self.frame_next = QPushButton("Next frame/page")
        self.frame_next.setAccessibleName("Next Frame Button")
        self.frame_next.setAccessibleDescription("Steps forward to the next frame or page in multi-frame images.")
        self.frame_next.setToolTip("Step forward to the next frame or page.")

        self.frame_seek = QSpinBox()
        self.frame_seek.setPrefix("Frame/page ")
        self.frame_seek.setAccessibleName("Frame or page number")
        self.frame_seek.setAccessibleDescription("Directly select a specific frame or page number.")
        self.frame_seek.setToolTip("Jump to a specific frame or page number.")

        self.frame_loop = QCheckBox("Loop continuously")
        self.frame_loop.setAccessibleName("Loop Animation Checkbox")
        self.frame_loop.setAccessibleDescription("Toggles continuous playback looping for multi-frame images.")
        self.frame_loop.setToolTip("Loop animation continuously during playback.")
