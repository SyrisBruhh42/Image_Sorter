...
class MainViewer(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        self.frame_previous.setAccessibleName("Previous frame or page")
        self.frame_previous.setAccessibleDescription("Steps back to the previous frame or page of an animated or multi-page image.")
        self.frame_play = QPushButton("Play")
        self.frame_play.setAccessibleName("Play or pause animation playback")
        self.frame_play.setAccessibleDescription("Toggles playback of animation or multi-page image frames.")
        self.frame_next = QPushButton("Next frame/page")
        self.frame_next.setAccessibleName("Next frame or page")
        self.frame_next.setAccessibleDescription("Steps forward to the next frame or page of an animated or multi-page image.")
