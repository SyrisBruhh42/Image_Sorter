...
class MainViewer(QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        self.frame_previous.setToolTip("Step to previous animation frame or document page.")
        self.frame_previous.setAccessibleName("Previous frame or page button")
        self.frame_play = QPushButton("Play")
        self.frame_play.setToolTip("Start or pause animation frame playback.")
        self.frame_play.setAccessibleName("Play or pause frame playback button")
        self.frame_next = QPushButton("Next frame/page")
        self.frame_next.setToolTip("Step to next animation frame or document page.")
